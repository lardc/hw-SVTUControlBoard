...
//
#define REG_UTCH2_P2					10	// Коэффициент точной корректировки UT на втором канале АЦП P2
#define REG_UTCH2_P1					11	// Коэффициент точной корректировки UT на втором канале АЦП P1
#define REG_UTCH2_P0					12	// Коэффициент точной корректировки UT на втором канале АЦП P0
#define REG_UTCH2_K						13	// Коэффициент пересчёта напряжения UT на втором канале АЦП
#define REG_UTCH2_B						14	// Смещение оцифрованного UT
//
