...
//
#define REG_UTCH2_P2					55	// Коэффициент точной корректировки UT на втором канале АЦП P2
#define REG_UTCH2_P1					56	// Коэффициент точной корректировки UT на втором канале АЦП P1
#define REG_UTCH2_P0					57	// Коэффициент точной корректировки UT на втором канале АЦП P0
#define REG_UTCH2_K						58	// Коэффициент пересчёта напряжения UT на втором канале АЦП
#define REG_UTCH2_B						59	// Смещение оцифрованного UT
//
