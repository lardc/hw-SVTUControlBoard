...
void INITCFG_ConfigDMA()
{
	...
	DMAChannelX_DataConfig(DMA_ADC_IG_CHANNEL, (uint32_t)(&MEMBUF_DMA_Ig[0]), (uint32_t)(&ADC1->DR), VALUES_IG_DMA_SIZE);
	...
	DMAChannelX_DataConfig(DMA_ADC_VG_CHANNEL, (uint32_t)(&MEMBUF_DMA_Vg[0]), (uint32_t)(&ADC2->DR), VALUES_VG_DMA_SIZE);
	...
	DMAChannelX_DataConfig(DMA_ADC_ID_CHANNEL, (uint32_t)(&MEMBUF_DMA_Id[0]), (uint32_t)(&ADC3->DR), VALUES_ID_DMA_SIZE);
	...
	DMAChannelX_DataConfig(DMA_ADC_VD_CHANNEL, (uint32_t)(&MEMBUF_DMA_Vd[0]), (uint32_t)(&ADC4->DR), VALUES_VD_DMA_SIZE);
