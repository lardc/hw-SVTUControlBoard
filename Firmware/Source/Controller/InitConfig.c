...
void INITCFG_ConfigGPIO()
{
	...
	GPIO_InitPushPullOutput(GPIO_SAFETY);
...
void INITCFG_ConfigDMA()
{
	...
	DMA_Interrupt(DMA_ADC_UT_CH, DMA_TRANSFER_COMPLETE, 0, true);
	DMAChannelX_DataConfig(DMA_ADC_UT_CH, (Int32U)(MEMBUF_DMA_Ut), (Int32U)(&ADC3->DR), VALUES_POWER_DMA_SIZE);
	...
	switch((Int16U)DataTable[REG_PCB_VERSION])
	{
		case PCB_VERSION_20:
			...
			if((Int16U)DataTable[REG_PCB_TIRIS_IGBT] == PCB_IGBT)
			{
				...
				DMA_Reset(DMA_ADC_IGBT_UGIG);
				DMA_Interrupt(DMA_ADC_IGBT_UGIG, DMA_TRANSFER_COMPLETE, 0, true);
				DMAChannelX_DataConfig(DMA_ADC_IGBT_UGIG, (Int32U)(MEMBUF_DMA_IGBT_UgIg), (Int32U)(&ADC2->DR), 2);
				DMAChannelX_Config(DMA_ADC_IGBT_UGIG, DMA_MEM2MEM_DIS, DMA_LvlPriority_LOW, DMA_MSIZE_32BIT,
