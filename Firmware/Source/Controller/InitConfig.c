...
void INITCFG_ConfigDMA()
{
	...
	DMAChannelX_DataConfig(DMA_ADC_IG_CHANNEL, (uint32_t)MEMBUF_DMA_Ig, (uint32_t)(&ADC1->DR), VALUES_DMA_SIZE);
	...
	DMAChannelX_DataConfig(DMA_ADC_VG_CHANNEL, (uint32_t)MEMBUF_DMA_Vg, (uint32_t)(&ADC2->DR), VALUES_DMA_SIZE);
	...
	DMAChannelX_DataConfig(DMA_ADC_ID_CHANNEL, (uint32_t)MEMBUF_DMA_Id, (uint32_t)(&ADC3->DR), VALUES_DMA_SIZE);
	...
	DMAChannelX_DataConfig(DMA_ADC_VD_CHANNEL, (uint32_t)MEMBUF_DMA_Vd, (uint32_t)(&ADC4->DR), VALUES_DMA_SIZE);
