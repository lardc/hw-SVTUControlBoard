...
// Variables
//
volatile Int16U MEMBUF_EP_Vd[VALUES_x_SIZE] = {0};
volatile Int16U MEMBUF_EP_Id[VALUES_x_SIZE] = {0};
volatile Int16U MEMBUF_EP_Vg[VALUES_x_SIZE] = {0};
volatile Int16U MEMBUF_EP_Ig[VALUES_x_SIZE] = {0};
