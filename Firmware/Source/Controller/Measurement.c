...
{
	MEASURE_ConvertADCtoValx(InputArray, OutputArray, DataLength, REG_VD_OFFSET, REG_VD_K, REG_VD_P0, REG_VD_P1, REG_VD_P2);
}
//------------------------------------

void MEASURE_ConvertId(uint16_t *InputArray, float *OutputArray, uint16_t DataLength)
{
	MEASURE_ConvertADCtoValx(InputArray, OutputArray, DataLength, REG_ID_OFFSET, REG_ID_K, REG_ID_P0, REG_ID_P1, REG_ID_P2);
}
//------------------------------------

void MEASURE_ConvertIdLow(uint16_t *InputArray, float *OutputArray, uint16_t DataLength)
{
	MEASURE_ConvertADCtoValx(InputArray, OutputArray, DataLength, REG_IDL_OFFSET, REG_IDL_K, REG_IDL_P0, REG_IDL_P1, REG_IDL_P2);
}
//------------------------------------

void MEASURE_ConvertVg(uint16_t *InputArray, float *OutputArray, uint16_t DataLength)
{
	MEASURE_ConvertADCtoValx(InputArray, OutputArray, DataLength, REG_VG_OFFSET, REG_VG_K, REG_VG_P0, REG_VG_P1, REG_VG_P2);
}
//------------------------------------

void MEASURE_ConvertIg(uint16_t *InputArray, float *OutputArray, uint16_t DataLength)
{
	MEASURE_ConvertADCtoValx(InputArray, OutputArray, DataLength, REG_IG_OFFSET, REG_IG_K, REG_IG_P0, REG_IG_P1, REG_IG_P2);
}
//------------------------------------
